...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"finalPrice\".\n" +
	"\tOrderList\x12!\n" +
	"\x06orders\x18\x01 \x03(\v2\t.pb.OrderR\x06orders2y\n" +
	"\fOrderService\x12@\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x17.pb.CreateOrderResponse\"\x00\x12'\n" +
	"\tGetOrders\x12\t.pb.blank\x1a\r.pb.OrderList\"\x00B\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	...
	0, // 2: pb.OrderService.GetOrders:input_type -> pb.blank
	2, // 3: pb.OrderService.CreateOrder:output_type -> pb.CreateOrderResponse
	4, // 4: pb.OrderService.GetOrders:output_type -> pb.OrderList
